...
// 			resp, _ := http.Post("http://localhost:8080/addInstance", "application/json", bytes.NewReader(json))
// 			defer resp.Body.Close()
// 		case input == "status":
// 			fmt.Println(instancesHistory)
// 		default:
// 			fmt.Println("unknown command. Use add or del INSTANCE_ID or status")
// 		}
// 	}
// }